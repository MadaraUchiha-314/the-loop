...
— iterating on the *rendered* output until the designer signs off, with every opinion
recorded as a ticket comment (paper trail). See `reference/design-artifacts.md`.

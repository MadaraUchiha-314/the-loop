...
# Pull requests: <work item title>

> Authored as pull requests are opened, gated at `reviewer-briefing`. A work item may be
...
> declared in `tasks.md`'s `repos:` front matter). List every one of them, not just the

...
const capabilitiesItems = [
  ...
  { text: "Standing sessions", link: "/capabilities/standing-sessions" },
  { text: "Lifecycle hooks", link: "/capabilities/lifecycle-hooks" },
  { text: "Observability", link: "/capabilities/observability" },
  { text: "Channels", link: "/capabilities/channels" },
...
const configSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Hook options", link: "/config/cli/hooks-options" },

...
| Full suite | `pytest -q` | pass — 1403 passed, 1 skipped (pre-existing; baseline before this work item was 1379 passed, 1 skipped) | [`evidence/tests.md`](evidence/tests.md) |

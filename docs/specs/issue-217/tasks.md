...
- [ ] 1. Runner core (`cli/tests/test_pdlc_e2e/runner.py`)
...
- [ ] 2. Happy-path scenario (fixtures + expected trace)
  ...
  - _Test:_ T1
- [ ] 3. Trivial-tier + ask-reply scenarios

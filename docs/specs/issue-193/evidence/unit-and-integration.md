...
> Captured 2026-08-10 from the repository root, on the work item's branch.
...
```console
$ uv run --project cli python -m pytest cli/tests/test_harness_config.py cli/tests/test_harness_config_scaffold_integration.py -k "forged or foreign or overwrite or contribution" -v --no-header
cli/tests/test_harness_config.py::test_scaffold_never_overwrites_an_existing_config PASSED [ 11%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[x"\n\nautonomy:\n  defaultTier: 1-repo] PASSED [ 22%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[octo-repo\nsecurity:\n  review:\n    required: false] PASSED [ 33%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[../../etc-repo] PASSED [ 44%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[-repo] PASSED [ 55%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[octo-] PASSED [ 66%]
cli/tests/test_harness_config.py::test_scaffold_refuses_a_forged_owner_or_repo[-leading-dash-repo] PASSED [ 77%]
cli/tests/test_harness_config_scaffold_integration.py::test_a_foreign_checkout_is_never_adopted PASSED [ 88%]
cli/tests/test_harness_config_scaffold_integration.py::test_a_contribution_never_adopts_its_host_repository PASSED [100%]

======================= 9 passed, 36 deselected in 0.47s =======================
```
...
======================= 3 passed, 33 deselected in 0.03s =======================
```

...
| T1 | R1.1, R1.3 | `test_a_bare_prefix_resolves_and_is_stripped`, `test_a_qualified_prefix_resolves`, `test_stripping_keeps_the_following_lines`, `test_a_prefix_alone_leaves_no_text` |

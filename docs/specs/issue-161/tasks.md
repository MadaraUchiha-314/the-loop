...
- [ ] 1. Core facade — `the_loop/core/` (workitems, events)
...
- [ ] 2. Core facade — graphs + repo-scoped ops
...
- [ ] 3. Core facade — sessions + daemons + attention
...
- [ ] 4. OpenAPI contract — `specs/openapi/the-loop.v1.yaml`
...
- [ ] 5. API app skeleton + auth boundary — `the_loop/api/`
...
- [ ] 6. API routers over the core + contract parity
...
- [ ] 7. Service lifecycle — `the-loop service start|stop|status`
...
- [ ] 8. CLI client seam — `the_loop/client/`
...
- [ ] 11. UI scaffold — `ui/` (Vite + TypeScript)
...
- [ ] 12. UI views — work items, detail (graph + controls), attention

...
| # | Title | Status | Date |
|---|-------|--------|------|
| [041](decision-041.md) | The paused label is an authorized-only control that writes the pause ledger; raw label presence is never read as state | proposed | 2026-07-26 |

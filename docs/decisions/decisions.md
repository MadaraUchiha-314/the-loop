...
| # | Title | Status | Date |
|---|-------|--------|------|
| [133](decision-133.md) | The knowledge graph is built headless in CI (`graphify extract --backend claude`, an API key on the `graphify` environment, no Claude Code in the job) and committed to `main` by the job through a rebase-and-retry script | proposed | 2026-09-19 |

...
| [writing-style](writing-style.md) | How the artifacts a human reads are written: the `the-loop:writing` skill, per-artifact prose budgets, the diagram-first rule and the formal-language carve-out. |
